...
if("undefined"==typeof jQuery)
	...
	+function(a){
		var b=a.fn.jquery.split(" ")[0].split(".");if(b[0]<2&&b[1]<9||1==b[0]&&9==b[1]&&b[2]<1)
	...
	(jQuery),+function(a){
		...
		c.prototype.setState=function(b){
			...
			f=d.data();
			b+="Text",
			null==f.resetText&&d.data("resetText",d[e]()),setTimeout(a.proxy(function(){
	...
	(jQuery),+function(a){
		...
		c.prototype.to=function(a){
			...
			this.pause().cycle():this.slide(a>c?
			"next":"prev",this.$items.eq(a))},
		...
		d.prototype.toggle=function(){
			...
			function(d){
				...
				c.call(f,h)})}(jQuery),+function(a){
					...
					".dropdown form",
					function(a){a.stopPropagation()}).on(
					"click.bs.dropdown.data-api",
					f,
					g.prototype.toggle).on(
					"keydown.bs.dropdown.data-api",
					f,
					g.prototype.keydown).on(
					"keydown.bs.dropdown.data-api",'[role="menu"]',
					g.prototype.keydown).on("keydown.bs.dropdown.data-api",'[role="listbox"]',
					g.prototype.keydown)
	}
	(jQuery),+function(a){
		"use strict";
		...
		c.prototype.show=function(b){
			...
			this.backdrop(function(){
				...
				d.$element.show().scrollTop(0),e&&d.$element[0].offsetWidth,
				d.$element.addClass("in").attr("aria-hidden",!1),
				d.enforceFocus();var f=a.Event("shown.bs.modal",{relatedTarget:b});
		...
		c.prototype.hide=function(b){
			...
			this.escape(),a(document).off("focusin.bs.modal"),
	...
	c.prototype.init=function(b,c,d){
		...
		for(var e=this.options.trigger.split(" "),f=e.length;f--;){
			var g=e[f];if("click"==g)this.$element.on("click."+this.type,
		...
		this.options,{trigger:"manual",selector:""}):this.fixTitle()
	},
	...
	c.prototype.getOptions=function(b){
		...
		c.prototype.enter=function(b){
			...
			void(c.hoverState="in"):(c||(c=new this.constructor(b.currentTarget,this.getDelegateOptions()),
		...
		c.prototype.leave=function(b){
			...
			c.prototype.show=function(){
				...
				if(this.hasContent()&&this.enabled){
					...
					this.options.placement.call(this,f[0],this.$element[0]):this.options.placement,i=/\s?auto?\s?/i,j=i.test(h);
					j&&(h=h.replace(i,"")||"top"),
					...
					if(j){
						...
						h="bottom"==h
						&&k.bottom+m>p.bottom?"top":"top"==h
						&&k.top-m<p.top?"bottom":"right"==h
						&&k.right+l>p.width?"left":"left"==h
						&&k.left-l<p.left?"right":h,f.removeClass(n).addClass(h)
					}
			...
			c.prototype.applyPlacement=function(b,c){
				...
				a.extend({using:function(a){d.css({top:Math.round(a.top),left:Math.round(a.left)})}},b),0),
				d.addClass("in");
				...
				m=l?2*k.left-e+i:2*k.top-f+j,n=l?"offsetWidth":"offsetHeight";
				d.offset(b),
